            ...
            <div className="max-w-6xl mx-auto py-12 px-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    <div className="lg:col-span-2 bg-white rounded-lg shadow-xl p-8 space-y-10">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-gray-800 mb-4 dark:text-gray-900">1. Your Contact Information</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700 dark:text-gray-100">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-100 dark:text-gray-900">Full Name *</label>
                                    <input 
                                        value={contactName} 
                                        onChange={e => setContactName(e.target.value)} 
                                        placeholder='Full Name'
                                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-3 focus:ring-indigo-500 focus:border-indigo-500 dark:text-black dark:placeholder:text-gray dark:border-black-600" 
                                        required
                                    />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-900">Email Address *</label>
                                    <input 
                                        type="email" 
                                        value={contactEmail} 
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-900">Phone Number *</label>
                                    <input 
                                        type="tel" 
                                        value={contactPhone} 
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-gray-800 mb-4 dark:text-gray-900">2. Participant(s) Information</h2>
                                ...
                                {participants.map((p, index) => (
                                    <div key={p.id} className="p-4 border rounded-lg bg-gray-50/50 relative">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                <label className="text-sm font-medium text-gray-900 dark:text-gray-900">First Name *</label>
                                                <input 
                                                    value={p.firstName} 
                                                    onChange={e => handleParticipantChange(index, 'firstName', e.target.value)}
                                                    placeholder='First Name' 
                                                    className="mt-1 block w-full rounded-md border border-gray-300 p-3 dark:text-black dark:placeholder:text-gray dark:border-black-600" 
                                                    required
                                                />
                                            </div>
                                            <div>
                                                <label className="text-sm font-medium text-gray-700 dark:text-gray-900">Last Name *</label>
                                                <input 
                                                    value={p.lastName} 
                                            ...
                                            <div>
                                                <label className="text-sm font-medium text-gray-700 dark:text-gray-900">Date of Birth *</label>
                                                <input 
                                                    type="date" 
                                                    value={p.dateOfBirth} 
                                            ...
                                            <div>
                                                <label className="text-sm block font-medium text-gray-700 dark:text-gray-900">Skill Level</label>
                                                <select 
                                                    value={p.skillLevel} 
                                            ...
                                            <div className="sm:col-span-2">
                                                <label className="text-sm font-medium text-gray-700 dark:text-gray-900">Medical Notes</label>
                                                <textarea 
                                                    value={p.medicalNotes} 
                                                    onChange={e => handleParticipantChange(index, 'medicalNotes', e.target.value)} 
                                                    placeholder='Medical Note'
                                                    className="mt-1 block w-full rounded-md border border-gray-300 dark:text-black dark:placeholder:text-gray dark:border-black-600" 
                                                    rows={2}
                                                ></textarea>
                                            </div>
                                            <div>
                                                <label className="text-sm font-medium text-gray-700 dark:text-gray-900">Emergency Contact Name *</label>
                                                <input 
                                            ...
                                            <div>
                                                <label className="text-sm font-medium text-gray-700 dark:text-gray-900">Emergency Contact Phone *</label>
                                                <input 
                                                    type="tel" 
                        ...
                        <section>
                            ...
                            {loading.sessions ? (
                                ...
                                <>
                                    <div className="mb-6">
                                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-900">Available Sessions *</label>
                                        <select 
                                            value={selectedSessionId || ''} 
                                            onChange={e => setSelectedSessionId(Number(e.target.value))} 
                                            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-3 dark:text-black dark:placeholder:text-gray dark:border-black-600"
                                            required
                                        >
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white dark:bg-white rounded-lg shadow-xl p-6 sticky top-24">
                            <h3 className="text-xl font-bold text-gray-800 border-b pb-4 mb-4 dark:text-gray-900">Booking Summary</h3>
                                ...
                                <div className="pt-4 space-y-2">
                                    <div className="flex gap-2">
                                        <input 
                                            ...
                                            className="w-full text-sm rounded-md border border-gray-300 shadow-sm p-2 dark:text-black dark:placeholder:text-gray dark:border-black-600" 
                                        />
                                        <button 
