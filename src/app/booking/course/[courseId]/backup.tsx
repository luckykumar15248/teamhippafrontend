    ...
    <div className="bg-gray-100 dark:bg-gray-900 min-h-screen">
      <div className="max-w-6xl mx-auto py-12 px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          <div className="lg:col-span-2 bg-white dark:bg-black rounded-lg shadow-xl p-8 space-y-10">
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700 dark:text-white">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-3 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:text-white dark:placeholder:text-white"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-100">
            ...
            <section>
              ...
              <div className="space-y-6">
                {participants.map((p, index) => (
                  <div
                    key={p.id}
                    className="p-4 border rounded-lg bg-gray-50/50 dark:bg-black relative"
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="mt-1 block w-full rounded-md border border-gray-300 p-3 dark:bg-gray-800 dark:text-white dark:placeholder:text-white"
                        />
                      </div>
                      <div>
                      ...
                      <div>
                        <label className="text-sm block font-medium text-gray-700 dark:text-white">
                          Skill Level
                        </label>
                        <select
                          value={p.skillLevel}
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <textarea
                          ...
                          placeholder="Notes"
                          className="mt-1 p-3 block w-full rounded-md border border-gray-300 dark:bg-gray-800  dark:text-white dark:placeholder:text-white"
                        ></textarea>
                      </div>
                    </div>
              ...
              <button
                ...
                className="mt-4 flex items-center text-sm font-medium text-indigo-600 dark:text-white hover:text-indigo-800"
              >
            ...
            <section>
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  className="mt-1 block w-full md:w-1/2 rounded-md border-gray-300 dark:border dark:border-white shadow-sm p-3 dark:text-gray-100 dark:bg-black"
                >
              ...
              <div className="bg-white dark:bg-black p-4 rounded-md border">
                ...
                <div className="grid grid-cols-7 gap-1 text-center text-xs font-semibold text-gray-500 dark:text-white">
                  <div>Sun</div>
                  <div>Mon</div>
                  <div>Tue</div>
                  <div>Wed</div>
                ...
                <div className="grid grid-cols-7 gap-1 mt-2 ">
                  {calendarDays.map((day, index) => {
                    ...
                    if (isAvailable && isFutureOrToday) {
                      dayClass = isSelected
                        ? "bg-indigo-600 dark:bg-white dark:!text-black text-white font-bold"
                        : "bg-green-100 hover:bg-green-200 cursor-pointer";
                    } else if (slot) {
                      dayClass =
                        "bg-red-100 dark:bg-red-100 text-red-400 dark:!text-black line-through cursor-not-allowed";
                    }
                    ...
                    return (
                      <div
                        ...
                        className={`p-2 border rounded-md h-16 flex flex-col justify-center items-center text-sm transition-colors ${dayClass} dark:bg-gray-800 dark:text-gray-100`}
                      >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-xl p-6 sticky top-24">
              <h3 className="text-xl font-bold text-gray-800 border-b pb-4 mb-4 dark:text-gray-100">
                Booking Summary
              </h3>
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between text-gray-700 dark:text-gray-100">
                  ...
                  <span className="font-semibold">{selectedDates.size}</span>
                </div>
                ...
                <div className="pt-4 space-y-2">
                  <div className="flex gap-2">
                    <input
                      ...
                      className="w-full text-sm rounded-md border border-gray-300 shadow-sm dark:text-white dark:placeholder:text-white p-2"
                    />
                    <button
