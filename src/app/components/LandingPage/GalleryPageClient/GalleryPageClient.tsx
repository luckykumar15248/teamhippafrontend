...
// Custom Lightbox Component to show image/video modal
...
// Masonry grid showing images/videos
...
const GalleryPageClient: React.FC = () => {
  // Types
  interface GalleryItem {
    id: number;
    title: string;
  ...
  // Fetch items when activeCategory changes
  useEffect(() => {
