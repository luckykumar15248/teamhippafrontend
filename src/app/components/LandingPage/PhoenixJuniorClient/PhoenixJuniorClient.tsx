  ...
  const renderTabContent = () => {
    switch (selectedTab) {
      case 'tots':
        return (
          <div>
            <h3 className="text-2xl font-bold mb-3">Tots Program (Ages 4-6)</h3>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                <CheckIcon />
                <span className="ml-2">Develops hand-eye coordination</span>
              </li>
              <li className="flex items-center">
                <CheckIcon />
                <span className="ml-2">Fun, safe, and positive environment</span>
              </li>
              <li className="flex items-center">
                <CheckIcon />
                <span className="ml-2">Prepares kids for future classes</span>
              </li>
            </ul>
          </div>
        );
      ...
      case 'beginners':
        return (
          <div>
            <h3 className="text-2xl font-bold mb-3">Beginners Program (Ages 7-10)</h3>
            <p className="text-gray-700 mb-4">
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                <CheckIcon />
                <span className="ml-2">Learn all major tennis strokes</span>
              </li>
              <li className="flex items-center">
                <CheckIcon />
                <span className="ml-2">Introduction to rallying and scoring</span>
              </li>
              <li className="flex items-center">
                <CheckIcon />
                <span className="ml-2">Focus on fun and sportsmanship</span>
              </li>
            </ul>
          </div>
        );
      ...
      case 'teens':
        return (
          <div>
            <h3 className="text-2xl font-bold mb-3">Teens Program (Ages 11-18)</h3>
            <p className="text-gray-700 mb-4">
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                <CheckIcon />
                <span className="ml-2">Ideal for middle & high school players</span>
              </li>
              <li className="flex items-center">
                <CheckIcon />
                <span className="ml-2">Great workout and social outlet</span>
              </li>
              <li className="flex items-center">
                <CheckIcon />
                <span className="ml-2">Prepares players for school teams</span>
              </li>
            </ul>
          </div>
        );
      ...
      case 'high-performance':
        return (
          <div>
            <h3 className="text-2xl font-bold mb-3">High-Performance Academy (Invitation Only)</h3>
            <p className="text-gray-700 mb-4">
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                <CheckIcon />
                <span className="ml-2">Advanced tactical and strategic drills</span>
              </li>
              <li className="flex items-center">
                <CheckIcon />
                <span className="ml-2">Off-court strength & conditioning</span>
              </li>
              <li className="flex items-center">
                <CheckIcon />
                <span className="ml-2">Focused tournament scheduling & coaching</span>
              </li>
            </ul>
          </div>
        );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="bg-white text-green-700 hover:bg-gray-100 px-8 py-3 text-lg font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all"
            >
              Start With Free Trial
            </button>
            <button
              onClick={() => document.getElementById('programs')?.scrollIntoView({ behavior: 'smooth' })}
              className="bg-green-800 border-2 border-white text-white hover:bg-white hover:text-green-700 px-8 py-3 text-lg font-semibold rounded-lg transition-all"
            >
              View Programs
            </button>
          </div>
      ...
      <section id="programs" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-700 mx-auto max-w-3xl">
            ...
            <span className="font-semibold">Rose Mofford Sports Complex</span>.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-lg p-8 min-h-[300px]">
          {renderTabContent()}
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {PHOENIX_COURSES.map((course) => (
              <div
                key={course.id}
                className="flex flex-col justify-between bg-white rounded-xl shadow-lg border border-gray-200 min-h-[400px] transition-transform hover:-translate-y-1 hover:shadow-xl"
              >
                <Image
                  src={course.image}
                  alt={course.title}
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <p className="text-gray-700 mb-5 flex-grow">{course.description}</p>
                  <div className="flex items-center gap-3 mt-auto">
                    <button
                      onClick={() => router.push(`/courses/${course.courseURL}`)}
                      className="border-2 border-green-600 text-green-600 bg-white rounded-lg px-6 py-2 font-semibold transition hover:bg-green-50"
                    >
                      View Details
                    </button>
                    <button
                      onClick={() => router.push(`/booking/course/${course.id}`)}
                      className="bg-green-600 text-white rounded-lg px-6 py-2 font-semibold shadow-md transition hover:bg-green-700"
                    >
                      Book Now
                    </button>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl font-bold text-gray-900 text-center mb-3">{group.program}</h3>
                <p className="text-green-600 font-semibold text-center mb-4">{group.focus}</p>
                ...
                <p className="text-sm text-gray-600 text-center">{group.duration}</p>
              </div>
            ))}
          </div>
        </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12">
      <a
        ...
        className="inline-flex items-center justify-center gap-2 bg-green-600 text-white px-8 py-4 rounded-lg hover:bg-green-700 transition-colors shadow-lg"
      >
      ...
      <a
       href="https://www.google.com/maps/place/Team+Hippa+-+Tennis+Academy/@33.0264402,-111.6789136,15z/data=!4m8!3m7!1s0xda8ab47fa7a90cd:0xf4d832507b1651bb!8m2!3d33.0264402!4d-111.6789136!9m1!1b1!16s%2Fg%2F11wwm9klzg?entry=ttu"
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center justify-center gap-2 border-2 border-green-600 text-green-600 px-8 py-4 rounded-lg hover:bg-green-50 transition-colors"
      >
        Write a Review
      </a>
    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              <h2 className="text-3xl font-bold text-black mb-3">Book Your Free Trial Class!</h2>
              <p className="text-gray-700 mb-6">
                Enter your details and we'll contact you to schedule a{' '}
                <span className="font-bold">free trial class</span> at our Phoenix location. No
                commitment, just fun!
              </p>
              <Inquiry />
            </div>
            ...
            <div className="text-center md:text-left">
              <h2 className="text-3xl font-bold text-black mb-4">Our Phoenix Tennis Facility</h2>
              <div className="mb-4">
                <p className="text-xl font-semibold text-gray-800">Rose Mofford Sports Complex</p>
                <p className="text-lg text-gray-600">9833 N 25th Ave</p>
                <p className="text-lg text-gray-600">Phoenix, AZ 85021</p>
              </div>
