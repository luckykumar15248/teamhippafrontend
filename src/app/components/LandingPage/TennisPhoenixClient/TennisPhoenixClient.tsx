...
import { PROGRAMS_MASTER } from "@/untils/constant";
import "swiper/css";
...
import { CalendarIcon, ClockIcon, MapPinIcon, UsersIcon, TrophyIcon,  } from "lucide-react";
...
interface TennisPhoenixClientProps {
  initialCourses: Course[];
  initialCategories: Category[];
  initialMappings: CourseCategoryMapping[];
}

const TennisPhoenixClient: React.FC<TennisPhoenixClientProps> = ({
  initialCourses,
  initialCategories,
  initialMappings,
}) => {
  ...
  useEffect(() => {
    if (initialCategories.length > 0) {
      setSelectedCategoryId(initialCategories[1].categoryId); // Your existing logic uses index 1
    }
  }, [initialCategories]);
   ...
   {/* Hero Section - Modern & Dynamic with Location Map */}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-left">
                <div className="inline-flex items-center gap-2 bg-green-50 text-green-700 px-4 py-2 rounded-full text-sm font-medium mb-6">
                  ...
                  ⭐ Best Tennis Lessons in Phoenix, Arizona
                </div>
                ...
                <p className="text-xl text-gray-600 mb-8 max-w-xl">
                  Looking for <strong>tennis lessons near me in Phoenix</strong>? Join Team Hippa at
                ...
                <div className="flex flex-wrap gap-2 mt-6">
                  ...
                  <Link href="/sports/tennis" className="text-sm text-green-600 hover:underline">tennis lessons Phoenix az</Link>
                  <span className="text-gray-300">•</span>
                  <Link href="/book-now/courses/junior-beginners-phoenix" className="text-sm text-green-600 hover:underline">junior tennis Phoenix</Link>
                  <span className="text-gray-300">•</span>
                  <Link href="/book-now/courses/adult-class-phoenix" className="text-sm text-green-600 hover:underline">adult tennis lessons near me</Link>
                </div>
              ...
              <section className="bg-gray-50 sticky top-0 z-10 backdrop-blur-md bg-white/90 border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="flex gap-1">
                    {[
                      { id: 'programs', label: 'Tennis Programs Phoenix', icon: TrophyIcon },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Best Tennis Programs in Phoenix, AZ
              </h2>
              ...
              {groupedCourses.map(([categoryName, { courses: courseList }]: [string, { courses: Course[]; order: number }]) => (
                <div key={categoryName}>
                  <div className="flex items-center gap-4 mb-8">
                    <h2 className="text-3xl font-bold text-gray-900">{categoryName} in Phoenix</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mt-2 mb-6">
                  Best Tennis Coaching in Phoenix with European Philosophy
                </h2>
                <div className="prose prose-lg text-gray-600">
                  <p className="mb-4">
                    <span className="font-bold text-gray-900">Team Hippa</span> is the <strong>top-rated tennis academy in Phoenix</strong>,
                  ...
                  <p>
                    ...
                    Team Hippa is a high-level tennis academy based in Phoenix, Arizona, built by a team of certified, internationally experienced coaches. Known for our modern training methods and strong European coaching philosophy, we’ve helped players of all ages grow their game through a balanced focus on technique, fitness, and mental strength.  We offer the best tennis lessons for kids, adults, and seniors near you. After success in the Phoenix area, we’re excited to expand into Phoenix, bringing our proven programs to Phoenix, Arizona. Whether you’re just starting out or competing at a high level, our mission is to provide the structure, flexibility, and support needed to help every player reach their full potential. Looking for tennis lessons in Phoenix, Arizona?. Our academy offers tennis training for all ages and levels — including new tennis programs at Phoenix Arizona.
                  </p>
                  <br />
                  <p>
              ...
              <div className="relative h-96">
                <Image
                  ...
                  alt="Tennis coaching in Phoenix Arizona"
                  fill
              ...
              {[
                {
                  ...
                  description: "Tennis lessons for all levels in Phoenix - from first-time players to tournament competitors.",
                  icon: TrophyIcon
                },
                {
                  title: "Kids & Adult Classes",
                  description: "Junior tennis programs and adult tennis lessons at Phoenix locations near you.",
                  icon: UsersIcon
                },
                {
                  title: "Community & Fun",
                  description: "More than just tennis lessons, we build a welcoming community for players of all ages in Phoenix. Join us for fun events, social mixers, and friendly competitions that make tennis enjoyable for everyone.",
                  icon: UsersIcon
                },
                {
                  title: "Flexible Scheduling",
                  description: "Book tennis courts and lessons in Phoenix when it works for you. No long-term contracts. We don’t lock players into rigid 8-week sessions or fixed times. With Team Hippa, you can:Purchase class packages at a discounted rate Use class credits to book sessions on your own schedule Train when it works for you, without sacrificing consistency This flexible structure is ideal for busy families, students, and adult players who want to stay active without the pressure of a fixed schedule.",
                  icon: ClockIcon
                },
                {
                  title: "European Coaching Philosophy, Right Here in Phoenix",
                  description: "Led by a team of highly educated, certified coaches, Team Hippa brings a European coaching philosophy focused on long-term player development, technical excellence, and a positive, competitive environment. Whether you’re picking up a racket for the first time or training for your next tournament, our mission is to provide the highest-quality tennis instruction in Phoenix.",
                  icon: TrophyIcon
                },

                {
                  title: "Proven Track Record in Phoenix",
                  description: "After years of success in the Phoenix area, we’re excited to bring our proven tennis programs to Phoenix. Our coaches have helped hundreds of local players improve their game, and we can’t wait to do the same for the Phoenix community.",
                  icon: TrophyIcon
                },
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Popular Tennis Programs in Phoenix, AZ
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Most booked tennis classes near you in Phoenix
            </p>
          </div>
              ...
              <SwiperSlide key={index}>
                <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition group">
                  <div className="relative h-48 overflow-hidden">
                    <Image
                      src={program.img}
                      alt={`${program.title} tennis lessons Phoenix AZ`}
                      width={400}
                      height={300}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Tennis Camps & Tournaments in Phoenix
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Competitive events, seasonal camps, and elite development opportunities for players in Phoenix.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 mb-20">
            ...
            <div className="group relative bg-gradient-to-br from-green-600 to-green-700 rounded-3xl p-10 text-white overflow-hidden hover:scale-[1.02] transition duration-300">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-3xl font-bold">
                  Tennis Camps in Phoenix
                </h3>
              </div>

              <p className="text-green-100 mb-8 leading-relaxed">
                Seasonal tennis camps designed for juniors and competitive players.
                Our Phoenix camps focus on technical development, match play,
            ...
            <div className="group relative bg-gray-900 rounded-3xl p-10 text-white hover:scale-[1.02] transition duration-300">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-3xl font-bold">
                  Tennis Tournaments in Phoenix
                </h3>
              </div>

              <p className="text-gray-300 mb-8 leading-relaxed">
                Compete in professionally organized tournaments right here in Phoenix.
          ...
          <div className="bg-gray-50 rounded-3xl p-12 text-center max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mb-10 max-w-2xl mx-auto">
              We’re expanding our tennis programs in Phoenix with new competitive leagues,
            ...
            <div className="grid sm:grid-cols-3 gap-6 mb-10 text-left">
              ...
              <div className="bg-white p-5 rounded-xl shadow-sm">
                ...
                <p className="text-sm text-gray-600">Learn pickleball skills or play casually with others in Phoenix.</p>
              </div>
              <div className="bg-white p-5 rounded-xl shadow-sm">
                <div className="font-semibold text-gray-900 mb-2">Tournaments and Match-Play opportunities</div>
                <p className="text-sm text-gray-600">Compete in organized tournaments and casual match-play events in Phoenix.</p>
              </div>
      ...
      <section className="relative bg-gray-900 py-24">
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4">
            Contact Us to Get Free Guidence for Tennis Lessons Near You in Phoenix
          </h2>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join 80+ local players at Phoenix top-rated tennis academy.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mt-2 mb-4">
              European Coaching Excellence in Phoenix
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-xl">
              <Image
                ...
                alt="European tennis coaching philosophy in Phoenix"
                fill
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="relative bg-white border border-green-100 rounded-3xl p-8 shadow-sm hover:shadow-md transition">
            ...
            <p className="text-gray-700 leading-relaxed mt-6">
              ...
              <span className="font-semibold text-green-700">
                tennis academy in Phoenix, Arizona?
              </span>
            </p>
          </div>
...
export default TennisPhoenixClient;