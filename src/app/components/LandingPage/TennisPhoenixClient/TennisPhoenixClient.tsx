     ...
     <section className="relative bg-gradient-to-r from-[#b0db72] to-[#3a702b] py-12 sm:py-16 md:py-20 px-6 lg:px-16 text-center text-white overflow-hidden">
        ...
        <div className="relative max-w-screen-xl mx-auto">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/90 font-light max-w-3xl mx-auto mb-8 leading-relaxed">
            ...
            experience! Whether you are an adult or a child, and regardless of
        ...
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="mb-12 bg-white shadow-md rounded-2xl p-6 md:p-10">
            ...
            <p className="mb-4 leading-relaxed text-base sm:text-lg text-gray-600 font-normal">
              ...
              philosophy, we helped players of all ages grow their game
              through a balanced focus on technique, fitness, and mental
              strength. After success in the Phoenix area, we are excited to
              expand into <span className="font-bold">Phoenix </span>, bringing
              our proven programs to
              <span className="font-bold"> Phoenix Regional Park</span>. Whether
            ...
            >
              Looking for tennis lessons in Phoenix , Arizona?
            </Link>
            <p className="leading-relaxed text-base sm:text-lg text-gray-600 font-normal">
              ...
              <span className="font-bold">Phoenix Regional Park </span> and{" "}
            ...
            <p className="text-base sm:text-lg text-gray-600 font-normal">
              ...
              including
              <span className="font-bold"> new tennis programs</span> at Phoenix
          ...
          <div className="mb-12 bg-green-50 border-l-4 border-green-600 rounded-md p-6">
            ...
            <p className="mb-4 leading-relaxed text-base sm:text-lg text-gray-600 font-normal">
              Unlike many tennis programs in Phoenix , we dont lock players
              into rigid 8-week sessions or fixed times. With Team Hippa, you
              can:
            </p>
          ...
          <div className="mb-12 bg-white shadow-md rounded-2xl p-6 md:p-10">
            <h2 className="text-2xl text-green-600 font-semibold uppercase mb-4">
              European Coaching Philosophy, Right Here in Phoenix
            </h2>
            <p className="mb-4 leading-relaxed text-base sm:text-lg text-gray-600 font-normal">
              Led by a team of{" "}
            ...
            <p className="leading-relaxed text-base sm:text-lg text-gray-600 font-normal">
              Whether you are picking up a racket for the first time or training
              for your next tournament, our mission is to provide the
              highest-quality tennis instruction in Phoenix .
            </p>
          </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="relative bg-green-600 text-white rounded-2xl p-6 shadow-lg">
            ...
            <p>
              ...
              <span className="font-semibold">tennis academy in Phoenix </span>,
              we embrace this mindset by designing sessions based on a players
          ...
          <div className="relative bg-black text-white rounded-2xl p-6 shadow-xl">
            ...
            <p>
              ...
              confidently and independently. Its an approach that develops not
          ...
          <div className="relative bg-white text-gray-800 rounded-2xl p-6 shadow-lg md:col-span-2">
            ...
            <p>
              ...
              their full potential. Just as importantly, we are creating a
              family-oriented, competitive atmosphere where both players and
              parents feel they are part of something meaningful. Thats why we
