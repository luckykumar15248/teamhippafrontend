...
import "./styles.css";
import { WINTER_CAMP_FAQS, PROGRAMS_MASTER, SCHEDULE, CAMP_FEATURES } from "@/untils/constant";
import "swiper/css";
      ...
      <div className="max-w-screen-xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {CAMP_FEATURES.map((feature, index) => (
            ...
            >
              <span className="text-4xl flex justify-center">{feature.icon}</span>
              <h4 className="text-xl font-semibold mt-4">{feature.title}</h4>
              <p className="text-base sm:text-lg font-normal mt-2">{feature.desc}</p>
            </div>
          ))}
        </div>
      </div>
                  ...
                  {index % 2 === 0 ? (
                    <>
                      <div className="w-1/2 pr-8 text-right">
                        ...
                        <p className="text-base sm:text-lg text-gray-600 mt-2">{item.desc}</p>
                      </div>
      ...
      <section className="bg-gradient-to-r bg-white py-12 sm:py-16 md:py-20 px-6 lg:px-16 text-center text-white overflow-hidden">
        <div className="relative max-w-screen-xl mx-auto">
          ...
          <p className="text-gray-600 text-base sm:text-lg md:text-xl font-light max-w-3xl mx-auto mb-8 leading-relaxed">
            ...
            your current skill level, our winter camps offer a premier
